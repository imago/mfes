...
define constant ionc = 0

define constant heapsize = 4000000

define coefficient epsilon_solv
(80*eps0),(4*eps0),(80*eps0)

define coefficient epsilon_ref
(4*eps0),(4*eps0),(4*eps0),(4*eps0)

define coefficient kappa
((8.43249*eps0)*ionc),0,0,0
...
define preconditioner c -type=multigrid -bilinearform=a_solv -xxinverse=mumps
define preconditioner c0 -type=multigrid -bilinearform=a_ref -xxinverse=mumps
